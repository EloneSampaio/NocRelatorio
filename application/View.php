...
//        print $this->_controller; exit;
    ...
    public function renderizar($nome, $item = FALSE) {
        ...
        if (Session::get('autenticado')) {
            ...
            $menu[] = array(
                "id" => "coyonet_hpas",
                "titulo" => "Coyonet e HPAS",
                "link" => URL . "coyonet_hpas"
            );

            $menu[] = array(
                "id" => "identificacao_turnos",
                "titulo" => "Identificação de Turnos",
                "link" => URL . "identificacao_turnos"
            );


            $menu[] = array(
                "id" => "servicos_logs",
                "titulo" => "Serviços e Logs",
                "link" => URL . "servicos_logs"
            );


            $menu[] = array(
                "id" => "radios",
                "titulo" => "Serviços de radios",
                "link" => URL . "radios"
            );
